...
//@nileio if this file exists there is an installation in progress - move directly to the installationReady page.
if (file_exists('install/_install_request.inc.php') && ($_REQUEST['file'] !== 'InstallationComplete.php') && ($_REQUEST['file'] !== 'PrepareInstall.php'))
	$_REQUEST['file'] = 'InstallationReady.php';
