...
(function (global, factory) {
  ...
  function getFillColor(element, defaultColor) {
	if (typeof(ProcessGraph) != 'undefined') defaultColor = ProcessGraph.getFillColor(element, defaultColor); // crmv@187568
    return getDi(element).get('bioc:fill') || defaultColor || 'white';
  }

  function getStrokeColor(element, defaultColor) {
	if (typeof(ProcessGraph) != 'undefined') defaultColor = ProcessGraph.getStrokeColor(element, defaultColor); // crmv@187568
