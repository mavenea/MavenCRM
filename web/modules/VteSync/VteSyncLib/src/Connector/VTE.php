...
class VTE extends BaseConnector {
	...
	protected function createUser($record) {
		...
		//@nileio TODO: check what does this do ??
		$fields['confirm_password'] = $fields['user_password'];
		$_REQUEST['CRMVNEWS'] = 'off'; //@nileio changed to off
		$_REQUEST['HELPVTE'] = 'off'; //@nileio changed to off
		$_REQUEST['MODCOMMENTS'] = 'off'; ///@nileio changed to off
		$_REQUEST['My files'] = 'off'; ///@nileio changed to off
