...
//		$this->loadPreferencesFromDB($row['user_preferences']);
	...
	//@nileio extend this function in order to remove the default homestuff and just include what you need
	...
	{		
		...
		//@nileio looks like those home widget defaults are hard coded in here
		//this is very weird that every new users we insert those duplicates in the reference table ! why is that ??
