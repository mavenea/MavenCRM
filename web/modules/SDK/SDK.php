...
static function getMenuButton($type, $module='', $action='') {
 	...
 	// crmv@140887
	//@nileio this function responsible for getting the list of buttons which are listed contextually for the a parituclar module and action
 	static function getMenuRawButton($type, $module = '', $action = '') {
 		...
 		if ($type == 'fixed') {
			...
			//@nileio TODO: the table has a condition check it out
 			$query = 'select * from sdk_menu_contestual where module = ?';
 			if ($action == 'ListView') {
 				$action = 'index';
 			}
