 ...
 */
function correctEncoding($text, $dest_encoding = 'UTF-8', $current_encoding = '', &$detectedEncoding = null)
{ // crmv@92218
	$text .= ' ';
	if ($current_encoding == '') {
	...
	if ($current_encoding != $dest_encoding) {
		...
		// BUG: found by @nileio on June2021iconv function should return a value but it returns false and so the entire sdk_language table is not populated
		// this could be an issue with iconv version used by php7-iconv
