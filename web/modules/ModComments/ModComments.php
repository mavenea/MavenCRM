...
class ModComments extends ModCommentsCore {
	...
	function addWidgetToAll() {
		global $adb,$table_prefix;
		//@nileio TODO: does this skip adding the comments module ? test this
		$skip_modcomm_module = array('Contacts','Emails','Fax','Sms','Events','ModComments','Charts','MyFiles','MyNotes'); // crmv@164120 crmv@164122
