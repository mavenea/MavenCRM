...
{elseif $uitype eq 23 || $uitype eq 5 || $uitype eq 6}
	...
	<div class="{$DIVCLASS}">
		...
		{if $uitype eq 6}
			{* crmv@181170
			{getTimeCombo('am', 'start', date('H'), date('i'), '', '', true)}  FIXME this function is not defined for use here*}
		...
		{if $uitype eq 23 && $ACTIVITY_MODE eq 'Events'}
			{* crmv@181170
			{getTimeCombo(null, 'end', date('H'), date('i'), '', '', true)} @nileio: FIXME this function is not defined for use here*}
