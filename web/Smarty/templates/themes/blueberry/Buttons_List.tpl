...
<ul id="Buttons_List_Fixed_Container" style="display:none;">
	...
	{* @nileio should include a check for calandar module active or not before enabling it on the right side panel*}
	{* Calendar *}
	...
	<li data-module="ModNotifications" data-fastpanel="half">
		<a href="javascript:;">
			<i data-toggle="tooltip" data-placement="top" class="vteicon" id="ModNotificationsCheckChangesImg" title="{'ModNotifications'|getTranslatedString:'ModNotifications'}">notifications</i>
		</a>
