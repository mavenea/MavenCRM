...
$check_phpcli =Common_Install_Wizard_Utils::check_phpcli();
				...
				<div class="col-xs-12 col-md-6" style="padding-left:0px">
					<div class="col-xs-12 nopadding">
						<table class="table table-striped">
                            ...
                            <tr>
                                <td><?php echo $installationStrings['LBL_PHPCLI']; ?></td>
                                <td><?php
                                    if ($check_phpcli == false) {
...
<script type="text/javascript">
	function isPermitted() {
		...
		<?php
		    ...
		    if (confirm('<?php echo $installationStrings['LBL_PHPCLI_NOTAVAILABLE']?>')){
		           return false;
		            } else {
		            return false;
		            }
