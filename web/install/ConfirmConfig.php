...
//TODO: remove this @nileio dump for debugging

  //  if ($fhandle=fopen('install/debug_reset_session.php','w+')){
  //      fwrite($fhandle,'<?php'. PHP_EOL . '$debugsessionInfo='. var_export($_SESSION,true) .';');
  //  }
		...
		<div class="col-xs-6 text-right">
			<?php if ($next) : ?>
				<form action="install.php" method="post" name="form" id="form">
					...
					<input type="hidden" name="file" value="SelectModules.php">
