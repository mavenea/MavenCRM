								...
								<div id="config-inner" class="col-xs-12 content-padding">
									<div class="col-xs-12 nopadding">
										<?php
                                            ...
                                            //@nileio
											$ins_errorlog_removed = $renameResult['install_errorlog_removed'] ;
                                            $ins_jobrequest_removed = $renameResult['install_jobrequest_removed'] ;
                                         //   $cronsleep_running = Common_Install_Wizard_Utils::startCronSleep($_SERVER['DOCUMENT_ROOT']);
												...
												<td align="center" class="small">
													...
													<div style="width:100%;padding:10px;" align="left">
														...
														<ul>
															...
															<?php } ?>
                                                            <?php if($ins_errorlog_removed==true && $ins_jobrequest_removed == true){ ?>
                                                                <li><?php echo $installationStrings['LBL_INSTALL_REQUEST_REMOVED'];?>.</li>
                                                            <?php } else { ?>
                                                                <li><font color='red'><?php echo $installationStrings['WARNING_INSTALL_REQUEST_REMOVED']; ?>.</font></li>
                                                            <?php } ?>
             <!--                                               <?php /*if($cronsleep_running == true){ */?>
                                                                <li><?php /*echo $installationStrings['LBL_CRONSLEEP_STARTED']. ' ' .$renamefile;*/?>install.</li>
                                                            <?php /*} else { */?>
                                                                <li><font color='red'><?php /*echo $installationStrings['WARNING_CRONSLEEP_NOTSTARTED']; */?>.</font></li>
                                                            --><?php /*} */?>
