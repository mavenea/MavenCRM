	...
	jQuery.ajax({
		...
		success: function(result) {
			...
			if (file == 'KanbanView') {
				...
				// crmv@168361
				// fix filter menu
				//@nilio for kanbanviw i am not sure why this is even needed at all
				//@nileio the whole solution for displaying customview links is now moved to the filter menu / embedded
