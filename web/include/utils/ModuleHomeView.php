...
class ModuleHomeView extends SDKExtendableClass {
	...
	public function getFilterContent($blockinfo) {
		...
		if (!empty($cvid)) {
            ...
            //@nileio - i will show the checkboxes in the block listview because my actions button is shown and require checkboxes
			$_REQUEST['hide_list_checkbox'] = '0';
			$_REQUEST['hide_custom_links'] = '0';
