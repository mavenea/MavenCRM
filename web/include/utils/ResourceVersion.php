...
class ResourceVersion extends SDKExtendableUniqueClass {
	...
	protected function generateName($file, $revision) {
		...
		if (!empty($this->resourcesCDN)) {
		    ...
		    //@nileio a new file name for the resource is here. this is why we get new files everytime
...
function resourcever($filename) {
	...
	//TODO: DISABLE VERSIONING of resources in here TO DEV/DEBUG. put this back in WHEN DONE.
