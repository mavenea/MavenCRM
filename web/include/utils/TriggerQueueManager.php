...
class TriggerQueueManager extends SDKExtendableUniqueClass {
	...
	protected $enabled_modules = array('Processes'); // has priority over disabled_modules and one array excludes the other ha priorità su disabled_modules e un array esclude l'altro
	...
	public function isEnabled($module, $crmid='') {
		...
		//@nileio BUGfix: should this be
		if ($VTEP->getProperty('performance.mq_rabbitmq_enabled')) {
	...
	protected function connect() {
		if (!$this->connection) {
			...
			$connection = new AMQPConnection(
                ...
                $rabbitmqConnection['virtual_host']  // vhost @nileio added vhost
